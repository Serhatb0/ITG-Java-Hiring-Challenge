package com.biricik.automotive.aspects;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.biricik.automotive.controllers.*.*(..))")
    ...
    @Around("@annotation(com.biricik.automotive.annotation.LogExecutionTime)")
